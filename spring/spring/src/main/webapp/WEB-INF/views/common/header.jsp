			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					...
					<c:if test="${loginStudent == null}">
						...
						onclick="location.assign('${path}/enrollstudent.do');">회원가입</button>
					</c:if>
					<c:if test="${loginStudent != null}">
						<span>	
							<a href="#">${loginStudent.studentNickname}</a>님 환영합니다.
						</span>
						<button class="btn btn-outline-dark" onclick="location.replace('${path}/logout.do');">로그아웃</button>
					</c:if>
				</div>
			</nav>	
		</div>	
